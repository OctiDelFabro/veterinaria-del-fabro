...
const variantStyles: Record<AdminProductStatusBadgeProps["variant"], string> = {
...
export function AdminProductStatusBadge({ label, variant }: AdminProductStatusBadgeProps) {
  return (
    <span
